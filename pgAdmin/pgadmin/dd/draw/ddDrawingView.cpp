...
ddDrawingView::ddDrawingView(wxWindow *ddParent, wxSize size, ddDrawing *drawing)// gqbController *controller, gqbModel *model)
...
ddCollection* ddDrawingView::selectionFigures(){
}
...
ddDrawing::gqbView(wxWindow *gqbParent, wxNotebook *gridParent, wxSize size, gqbController *controller, gqbModel *model)
